                    ...
                    <div class="col-md-12">
                        ...
                        <div class="topbar-nav topbar-right">
                            <form class="search-form" action="search">
                                <?php $searchText = isset($searchText) ? $searchText : "";?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-offset-3 col-md-6 col-sm-offset-2 col-sm-8">
                        ...
                        <form class="form-inline subscription-form" action="{{SR::$baseUrl}}subscribe" method="post">
                        ...
                        <ul class="footer-menu">
                            ...
                            <li><a href="{{SR::$baseUrl}}page/privacy-policy">Privacy Policy</a></li>
                            <li><a href="{{SR::$baseUrl}}page/terms-and-condition">Terms and Condition</a></li>
                        </ul>
                    </div>
                </div>
                <!-- break -->
